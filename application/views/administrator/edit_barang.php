        ...
        <div class="container-fluid">
            ...
            <div class="card sahdow mb-4">
                ...
                <?php foreach ($barang as $b) : ?>
                        <form action="<?= base_url() . 'admin/databaranglelang/update/' . $b->id_barang;  ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id_barang" value="<?= $b->id_barang ?>">
                            ...
                            <div class="from-group">
                                ...
                                <textarea type="text" name="keterangan" id="keterangan" class="form-control" required  cols="5" rows="3"><?= $b->keterangan ?></textarea>
                            </div><br>
                            ...
                            <div class="from-group">
                                ...
                                <input type="file" name="photo" id="photo" class="form-control" value="<?= $b->photo; ?>">
                            </div><br>

                            <br>
                            <button class="btn btn-secondary" type="submit" name="submit">Ubah Data</button>
                            <a href="<?= base_url() ?>admin/databaranglelang" class="btn btn-danger">Kembali</a> <br><br>
