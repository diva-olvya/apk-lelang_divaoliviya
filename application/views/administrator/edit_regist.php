        ...
        <div class="container-fluid">
            ...
            <div class="card sahdow mb-4">
                ...
                <?php foreach ($petugas as $p) : ?>
                        <form action="<?= base_url() . 'admin/dataadmin/update' ?>" method="post" enctype="multipart/form-data">
                            ...
                            <!-- password tidak bisa dirubah -->
                            <div class="from-group">
                                <label>Password :</label>
                                <input type="number" name="password" id="password" class="form-control" required  value="<?= $p->password ?>"> 
                            </div>
