    ...
    <div class="card shadow mb-4">
        <div class="card-body bg-light">
            ...
            <div class="form-group row">
                ...
                <div>
                    <a href="<?= base_url('admin/laporan/cetak_laporan_pemenang'); ?>" class="btn btn-primary" data-toggle="modal" data-target="#cetaklaporanpemenang">Cetak Data Pemenang</a>
                </div>
            </div>
            <hr>
            ...
            <div class="form-group row">
                ...
                <div>
                    <a href="<?= base_url('admin/laporan/cetak_laporan_lelang'); ?>" class="btn btn-primary" data-toggle="modal" data-target="#cetaklaporanlelang">Cetak Data Lelang</a>
                </div>
            </div>
...
<div class="modal fade" id="cetaklaporanpemenang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('admin/laporan/cetak_laporan_pemenang') ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="cetaklaporanlelang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('admin/laporan/cetak_laporan_lelang') ?>" method="post" enctype="multipart/form-data">
