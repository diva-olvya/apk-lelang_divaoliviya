            ...
            <table class="table table-bordered table-striped alert alert-primary">
                ...
                foreach ($barang as $b) : ?>
                    ...
                    <td class="text-center"><?= $no++ ?></td>
                        ...
                        <td>
                            <!-- untuk otomatis ketika status dilelalangkan berubah menjadi status dilelang -->
							<?php
                        ...
                        <td class="text-center">
                            <!-- untuk status barang ketika sudah dilelang maka akan tampil action edit saja(kenapa tidak yang hapus karena berelasi jadi tidak bisa dihapus) -->
                            <center>
                            <?php if (empty($b->status_barang)) : ?>
                                <a class="btn btn-sm btn-primary mb-2" href="<?= base_url('petugas/databarangpetugas/edit/' . $b->id_barang) ?>"><i class="fas fa-edit"></i></a>
                                <a onclick="return confirm('Apakah Anda Yakin Akan Menghapus Barang Ini?')" class="btn btn-sm btn-danger mb-2" href="<?= base_url('petugas/databarangpetugas/hapus/' . $b->id_barang) ?>"><i class="fas fa-trash"></i></a>

                                <!-- <a href="#" onclick="hapuSdatabarangpetugas('<?= base_url('petugas/databarangpetugas/hapus/')  . $b->id_barang ?>')" class="badge badge-danger btn-sm tombol-hapus">Delete</a> -->
                            <?php else : ?>
                                <center> - </center>
                            <?php endif; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <form action="<?= base_url() . 'petugas/databarangpetugas/tambah_aksi' ?>" method="post" enctype="multipart/form-data"> -->
                
                    <?= form_open_multipart('petugas/databarangpetugas/tambah_aksi') ?>
