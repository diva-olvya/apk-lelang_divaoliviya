...
class Auth extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('nama_lengkap', ' Nama Lengkap', 'required|is_unique[tb_masyarakat.nama_lengkap]', ['required' => 'Nama wajib diisi!']);
        $this->form_validation->set_rules('username', ' Username', 'required|is_unique[tb_masyarakat.username]', ['required' => 'Username wajib diisi!']);
    ...
    public function forgotpassword(){
        $data['title'] = 'ForgotPassword';  //untuk membuat judul halaman
        $this->load->view('templates/auth_header', $data);
